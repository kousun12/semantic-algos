# Worker prompt · 017 leaf 2.2 question-forge
...
Application: 017, `forgeReport <- questionForge surfaceQuestion` for leaf 2.2.
...
1. [Leaf 2.2 surface question](../016-leaf-2-2-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/017-leaf-2-2-forge/result.md`
...
- Inputs: [leaf 2.2 surface question](../016-leaf-2-2-heart/result.md)
