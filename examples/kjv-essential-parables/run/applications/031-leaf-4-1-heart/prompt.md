# Worker prompt · 031 leaf 4.1 heart
...
Application: 031, `surfaceQuestion <- formIndependentHeartQuestion leaf` for leaf 4.1.
...
Leaf title: `Paul's Gospel and the Life of the Churches`
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/031-leaf-4-1-heart/result.md`
...
- Inputs: literal leaf 4.1 descriptor structurally projected from application 003
