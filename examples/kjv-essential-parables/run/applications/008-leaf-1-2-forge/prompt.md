# Worker prompt · 008 leaf 1.2 question-forge
...
Application: 008, `forgeReport <- questionForge surfaceQuestion` for leaf 1.2.
...
1. [Leaf 1.2 surface question](../007-leaf-1-2-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/008-leaf-1-2-forge/result.md`
...
- Inputs: [leaf 1.2 surface question](../007-leaf-1-2-heart/result.md)
