# Worker prompt · 032 leaf 4.1 question-forge
...
Application: 032, `forgeReport <- questionForge surfaceQuestion` for leaf 4.1.
...
1. [Leaf 4.1 surface question](../031-leaf-4-1-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/032-leaf-4-1-forge/result.md`
...
- Inputs: [leaf 4.1 surface question](../031-leaf-4-1-heart/result.md)
