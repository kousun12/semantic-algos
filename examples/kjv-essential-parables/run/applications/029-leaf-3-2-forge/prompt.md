# Worker prompt · 029 leaf 3.2 question-forge
...
Application: 029, `forgeReport <- questionForge surfaceQuestion` for leaf 3.2.
...
1. [Leaf 3.2 surface question](../028-leaf-3-2-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/029-leaf-3-2-forge/result.md`
...
- Inputs: [leaf 3.2 surface question](../028-leaf-3-2-heart/result.md)
