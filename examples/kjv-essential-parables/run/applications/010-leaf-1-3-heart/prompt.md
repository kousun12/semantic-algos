# Worker prompt · 010 leaf 1.3 heart
...
Application: 010, `surfaceQuestion <- formIndependentHeartQuestion leaf` for leaf 1.3.
...
Leaf title: `Exodus, Sinai, and the Wilderness`
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/010-leaf-1-3-heart/result.md`
...
- Inputs: literal leaf 1.3 descriptor structurally projected from application 003
