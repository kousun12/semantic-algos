# Worker prompt · 003 build-major-minor-outline
...
Configuration: terminal leaf target 8–12; hard cap 12; recognizable corpus order; representative rather than book-by-book.

Expected result: one independently intelligible hierarchical outline. Each terminal leaf must have an explicit number, concise title, scope description, and central material sufficient for a downstream independent question. State briefly that it is one coherent structural reading, not uniquely canonical.
...
- Configuration: 8–12 terminal leaves; hard cap 12
