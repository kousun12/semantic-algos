# Worker prompt · 026 leaf 3.1 question-forge
...
Application: 026, `forgeReport <- questionForge surfaceQuestion` for leaf 3.1.
...
1. [Leaf 3.1 surface question](../025-leaf-3-1-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/026-leaf-3-1-forge/result.md`
...
- Inputs: [leaf 3.1 surface question](../025-leaf-3-1-heart/result.md)
