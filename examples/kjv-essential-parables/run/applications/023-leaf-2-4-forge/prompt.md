# Worker prompt · 023 leaf 2.4 question-forge
...
Application: 023, `forgeReport <- questionForge surfaceQuestion` for leaf 2.4.
...
1. [Leaf 2.4 surface question](../022-leaf-2-4-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/023-leaf-2-4-forge/result.md`
...
- Inputs: [leaf 2.4 surface question](../022-leaf-2-4-heart/result.md)
