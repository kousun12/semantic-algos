# Worker prompt · 004 leaf 1.1 heart
...
Application: 004, `surfaceQuestion <- formIndependentHeartQuestion leaf` for leaf 1.1.
...
Leaf title: `Creation, Ruin, and the Nations`
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/004-leaf-1-1-heart/result.md`
...
- Inputs: literal leaf 1.1 descriptor structurally projected from application 003
