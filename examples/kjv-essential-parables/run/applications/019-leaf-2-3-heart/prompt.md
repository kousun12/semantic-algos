# Worker prompt · 019 leaf 2.3 heart
...
Application: 019, `surfaceQuestion <- formIndependentHeartQuestion leaf` for leaf 2.3.
...
Leaf title: `Prayer, Suffering, and the Search for Wisdom`
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/019-leaf-2-3-heart/result.md`
...
- Inputs: literal leaf 2.3 descriptor structurally projected from application 003
