# Worker prompt · 035 leaf 4.2 question-forge
...
Application: 035, `forgeReport <- questionForge surfaceQuestion` for leaf 4.2.
...
1. [Leaf 4.2 surface question](../034-leaf-4-2-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/035-leaf-4-2-forge/result.md`
...
- Inputs: [leaf 4.2 surface question](../034-leaf-4-2-heart/result.md)
