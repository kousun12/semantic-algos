# Worker prompt · 005 leaf 1.1 question-forge
...
Application: 005, `forgeReport <- questionForge surfaceQuestion` for leaf 1.1.
...
1. [Leaf 1.1 surface question](../004-leaf-1-1-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/005-leaf-1-1-forge/result.md`
...
- Inputs: [leaf 1.1 surface question](../004-leaf-1-1-heart/result.md)
