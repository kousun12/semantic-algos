# Worker prompt · 014 leaf 2.1 question-forge
...
Application: 014, `forgeReport <- questionForge surfaceQuestion` for leaf 2.1.
...
1. [Leaf 2.1 surface question](../013-leaf-2-1-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/014-leaf-2-1-forge/result.md`
...
- Inputs: [leaf 2.1 surface question](../013-leaf-2-1-heart/result.md)
