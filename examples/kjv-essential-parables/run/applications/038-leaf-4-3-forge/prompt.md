# Worker prompt · 038 leaf 4.3 question-forge
...
Application: 038, `forgeReport <- questionForge surfaceQuestion` for leaf 4.3.
...
1. [Leaf 4.3 surface question](../037-leaf-4-3-heart/result.md) — use only its `## Result` section.
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/038-leaf-4-3-forge/result.md`
...
- Inputs: [leaf 4.3 surface question](../037-leaf-4-3-heart/result.md)
