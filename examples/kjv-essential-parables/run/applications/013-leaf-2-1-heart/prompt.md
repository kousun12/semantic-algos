# Worker prompt · 013 leaf 2.1 heart
...
Application: 013, `surfaceQuestion <- formIndependentHeartQuestion leaf` for leaf 2.1.
...
Leaf title: `Conquest, Settlement, and the Age of the Judges`
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/013-leaf-2-1-heart/result.md`
...
- Inputs: literal leaf 2.1 descriptor structurally projected from application 003
