# Worker prompt · 016 leaf 2.2 heart
...
Application: 016, `surfaceQuestion <- formIndependentHeartQuestion leaf` for leaf 2.2.
...
Leaf title: `Monarchy, Division, Exile, and Return`
...
`/Users/rob/code/semantic-algos/sem-runs/kjv-essential-parables/2026-08-01-1234/applications/016-leaf-2-2-heart/result.md`
...
- Inputs: literal leaf 2.2 descriptor structurally projected from application 003
